...
import { PlopsaScopedSkills, type PlopsaSkillsSection } from "./scoped-skills";
 ...
 * on-brand presentations, follow-up). Structure, sections, and
 * component composition are the Exalate route's; the divergence is
 * the palette.
 *
...
/* The Plopsa turn of the Skills beat: six Skills scoped live in the
   10 July 2026 session, matched to the person who raised the
   workflow in the intro round. Rendered by PlopsaScopedSkills
   directly after the Loop donut. */
const plopsaSkillsSection: PlopsaSkillsSection = {
  id: "plopsa-skills",
  ariaLabel: "Six Skills scoped for the Plopsa marketing team",
  title: "The first six Skills",
  titleEm: "we scoped in the room.",
  accentLine: "For Plopsa",
  ...
  cards: [
    {
      id: "plopsa-genai-prompting",
      title: "Plopsa Gen-AI Prompting",
      owner: "Radan",
      body: "Fork the shared prompting skill and load it with the Plopsa brand book. Every Nano Banana, GPT-Image-2, or Seedance prompt starts on-brand instead of from a blank page.",
    ...
    {
      id: "plopsa-tone-of-voice",
      title: "Plopsa Tone of Voice",
      owner: "Hugo",
      body: "One briefing that holds the brand and tone rules, so Claude drafts copy that already sounds like Plopsa. Web, SEO, and paid in one pass.",
          ...
          <RoleProvider>
            ...
            <UseCasesProvider>
              ...
              <SkillsByTeam
                ...
                showRepo={false}
              />
              <PlopsaScopedSkills section={plopsaSkillsSection} />
              <EvansBridge />

...
/*
 * PlopsaScopedSkills — the "For Plopsa" turn of the Skills beat.
 *
...
export type PlopsaSkillsSection = {
  id: string;
  ariaLabel: string;
  title: string;
  titleEm: string;
...
export function PlopsaScopedSkills({
  section,
}: {
  section: PlopsaSkillsSection;
}) {
  return (
    <section
      className="aiop-section ca-skills plopsa-skills"
      id={section.id}
    ...
    >
      <div className="aiop-wrap">
        ...
        <ul
          className="ca-team__cards plopsa-skills__cards aiop-reveal"
          role="list"
        >
        ...
        {section.moreTail ? (
          <p className="ca-team__more-tail plopsa-skills__more-tail aiop-reveal">
            {section.moreTail}
          </p>
        ) : null}
      </div>
